import improveTasks from '@/services/mockData/improveTasks.json';

const delay = (ms) => new Promise(resolve => setTimeout(resolve, ms));

class ImproveTasksService {
  constructor() {
    this.taskType = 'Improve';
    this.data = [...improveTasks];
  }
...
export default new ImproveTasksService();